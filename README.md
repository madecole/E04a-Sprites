...
This program displays sprites in various ways. It utilizes a randomized sprite selection and placement, sprites "interacting", and a sprite that follows the mouse's coordinates.
